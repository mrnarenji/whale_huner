...
def get_ranks(symbols):
    ...
    url = f"https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?symbol={symbols_string}&CMC_PRO_API_KEY={coinmarketcap_api_key}"
...
def send_to_telegram(chatid,message):
    ...
    chatID = chatid
    apiURL = f'https://api.telegram.org/bot{telegram_bot_apitoken}/sendMessage'
